            ...
            <div className='flex justify-center items-center' >
                <div className='border-2 px-10 py-16 m-10 rounded-lg'>
                    ...
                    <div>
                        ...
                        <button className=' ml-8 my-5 border-2 py-1 text-center px-7 rounded-3xl'><Image width='20px' height='20px' className=' inline  ' src={googleLogo} alt="" /> Continue with Google </button>
